...
namespace Opten.Umbraco.ListView.PropertyEditors
{
	...
	public class ListViewPropertyEditor : PropertyEditor
	{
		...
		internal class ListViewPreValueEditor : PreValueEditor
		{
			...
			[PreValueField("contentTypeAliases", "Content Types", "textstring", Description = "Only show items with this content type in view. comma separated")]
			public int ContentTypeAliases { get; set; }
